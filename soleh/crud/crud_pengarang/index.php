...
<html>
    ...
    <nav class="navbar">
        ...
        <a href="add.php" class="btn btn-primary m-2">Add New Pengarang</a><br/><br/>
        <table class="table">
            ...
            <?php
                ...
                <tbody>   
                    ...
                    <!-- Jika kita lihat di url kalau variabel isbn itu udah ke bawa jadi kalau kita kehalaman edit/delete variabel isbn harus ada -->
                        <td>
                            <a class='btn btn-primary' href="edit.php?id_pengarang=<?= $row['id_pengarang']; ?> ">Edit</a> | 
                            <a class='btn btn-danger' href="delete.php?id_pengarang=<?= $row['id_pengarang']; ?>" onclick="return confirm('yakin ingin menghapus data?')">Delete</a>
                        </td>
                    </tr>
                </tbody> 
            <?php endwhile; ?>
