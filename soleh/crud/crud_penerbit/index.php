        ...
        <table class="table" width="80%" border=1>
            ...
            <?php
                while($row = mysqli_fetch_array($penerbit)) {
                    ...
                    echo "<td><a class='btn btn-primary' href='edit.php?id_penerbit=$row[id_penerbit]'>Edit</a> | <a class='btn btn-danger' href='delete.php?id_penerbit=$row[id_penerbit]'>Delete</a></td></tr>";
                }
            ?>
        </table>
    </body>
